...
namespace Main
{
    public static class Matrix4x4Extension
    {
        ...
        public static Matrix4x4 MultiplyByNumber(this Matrix4x4 matrix, float number)
        {
        ...
        public static Matrix4x4 HouseholderReflection(this Matrix4x4 matrix4X4, Vector3 planeNormal)
        {
            ...
            Matrix4x4 householderMatrix = Matrix4x4.identity.Minus(MultiplyVectorsTransposed(planeNormal4, planeNormal4).MultiplyByNumber(2));
